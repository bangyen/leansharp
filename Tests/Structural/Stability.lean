...
/-!
# Structural Stability Interface Tests
...
theorem test_hard_threshold_scalar_not_lipschitz_interface
    (τ : ℝ) (hτ : 0 < τ) (K : NNReal) :
...
theorem test_localized_filtered_update_norm_bound_interface
    (w g : W ι) (η z R : ℝ)
    (hR : ‖g‖ ≤ R) :
...
theorem test_uniform_filtered_process_stability_interface
