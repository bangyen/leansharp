...
import LeanSharp.Theory.Robustness.Alignment
...
This module exists to expose contamination and sensitivity guarantees through a
single import for robustness-focused theorem development.
-/
